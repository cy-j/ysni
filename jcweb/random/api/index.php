...
const ERROR_IMG = [
    404 => 'https://www.ysni.cn/404',
    503 => 'https://www.ysni.cn/about/'
 ];

if (file_exists('../ysniurl.csv')) {
    $url = file('../ysniurl.csv', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
} else {
    $url = file('http://' . $_SERVER['HTTP_HOST'] . '/ysniurl.csv', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
}
